...
for sub in subs:
    ...
    prec = np.load(op.join(wd, 'data', 'tuningcurves', '500hz', 'parameter_fits', 'smooth_distances',
                f's{sub}_ParamFits_precision_binstep{binstep}_binwidth{binwidth}.npy'))
    
    ampglm = np.load(op.join(wd, 'data', 'tuningcurves', '500hz', 'parameter_fits', 'smooth_distances',
...
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_distances', 'beh_glm', f'TCParamsXbehaviour_beta_precision_binstep{binstep}_binwidth{binwidth}.npy'),  arr = b_prec)
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_distances', 'beh_glm', f'TCParamsXbehaviour_beta_amplitude_binstep{binstep}_binwidth{binwidth}.npy'),  arr = b_amp)
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_distances', 'beh_glm', f'TCParamsXbehaviour_tstat_precision_binstep{binstep}_binwidth{binwidth}.npy'), arr = t_prec)
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_distances', 'beh_glm', f'TCParamsXbehaviour_tstat_amplitude_binstep{binstep}_binwidth{binwidth}.npy'), arr = t_amp)
