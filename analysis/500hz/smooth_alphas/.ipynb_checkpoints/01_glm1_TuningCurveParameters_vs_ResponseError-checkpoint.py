...
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_alphas', 'beh_glm', f'TCParamsXbehaviour_beta_precision_binstep{binstep}_binwidth{binwidth}.npy'),  arr = b_prec)
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_alphas', 'beh_glm', f'TCParamsXbehaviour_beta_amplitude_binstep{binstep}_binwidth{binwidth}.npy'),  arr = b_amp)
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_alphas', 'beh_glm', f'TCParamsXbehaviour_tstat_precision_binstep{binstep}_binwidth{binwidth}.npy'), arr = t_prec)
np.save(op.join(wd, 'data', 'glms', '500hz', 'smooth_alphas', 'beh_glm', f'TCParamsXbehaviour_tstat_amplitude_binstep{binstep}_binwidth{binwidth}.npy'), arr = t_amp)
