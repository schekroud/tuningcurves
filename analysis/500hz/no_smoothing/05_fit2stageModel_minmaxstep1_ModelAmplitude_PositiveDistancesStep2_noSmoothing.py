...
for i in subs:
    ...
    if op.exists(op.join(wd, 'data', 'tuningcurves', '500hz', 'parameter_fits', 'no_smoothing',
        ...
        alphas = np.load(op.join(wd, 'data', 'tuningcurves', '500hz', 'parameter_fits', 'no_smoothing',
                f's{i}_ParamFits_Alpha_binstep{binstep}_binwidth{binwidth}_smoothedAlpha_{smooth_alphas}{smooth_sigma}.npy'))
    else:
    ...
    if i==4:
        ...
        np.save(op.join(wd, 'data', 'tuningcurves', '500hz', 'parameter_fits', 'no_smoothing', 'model_settings.npy'), model_settings)
    
    #save tuning curve model parameters
    np.save(op.join(wd, 'data', 'tuningcurves', '500hz', 'parameter_fits', 'no_smoothing',
